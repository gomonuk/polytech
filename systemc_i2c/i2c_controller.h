...
SC_MODULE(i2c_controller)
        {
                ...
                sc_out<bool> ready;
                sc_out<bool> i2c_scl_m;
                sc_out<bool> i2c_sda_m;
                sc_out<sc_logic> i2c_sda_o;
                sc_out<sc_logic> i2c_scl_o;
                ...
                SC_CTOR(i2c_controller)
                {
                    ...
                    SC_METHOD(sda_m_assign);
                    sensitive << i2c_sda_o;

                    SC_METHOD(ready_assign);
                    sensitive << rst << state;

                    SC_METHOD(i2c_scl_o_assign);
                    sensitive  << i2c_clk;

                    SC_METHOD(scl_m_assign);
                    sensitive << i2c_scl_o;
